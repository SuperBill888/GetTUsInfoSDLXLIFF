    ...
    while True:
        ...
        if event=='_Convert_':
            ...
            if len(tulist)>0:
                ...
                wsh.write(i,1,'Source')
                wsh.write(i,2,'Source Lanuage Code')
                wsh.write(i,3,'Target')
                wsh.write(i,4,'Target Lanuage Code')
                wsh.write(i,5,'Status')
                wsh.write(i,6,'Structure')
                wsh.write(i,7,'origin')
                wsh.write(i,8,'origin-system')
                wsh.write(i,9,'percent')
                wsh.write(i,10,'Locked')
