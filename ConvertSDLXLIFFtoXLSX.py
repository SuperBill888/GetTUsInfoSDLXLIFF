    ...
    while True:
        ...
        if event=='_Convert_':
            ...
            if len(tulist)>0:
                ...
                wsh.write(i,0,'Filepath')
                wsh.write(i,1,'SegmentID')
                wsh.write(i,2,'Source')
                wsh.write(i,3,'Source Lanuage Code')
                wsh.write(i,4,'Target')
                wsh.write(i,5,'Target Lanuage Code')
                wsh.write(i,6,'Status')
                wsh.write(i,7,'Structure')
                wsh.write(i,8,'origin')
                wsh.write(i,9,'origin-system')
                wsh.write(i,10,'percent')
                wsh.write(i,11,'Locked')
